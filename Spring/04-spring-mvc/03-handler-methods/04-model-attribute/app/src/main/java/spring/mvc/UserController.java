...
@Controller
    ...
    */
    ...
    public String submitDetails(@ModelAttribute("person") Person person, @ModelAttribute("address") Address address) {
    ...
    /* Actually, using @ModelAttribute is optional. Any parameter that is not a simple type is treated as ModelAttribute */
    /*
    @PostMapping("/submitDetails")
    public String submitDetails(Person person, Address address) {
        // Process the data (e.g., save to database)
